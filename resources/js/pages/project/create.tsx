...
export function CreateProjectDialog({ open, isOpen }: Props) {
    const { data, setData, errors, processing, reset, post } = useForm<ProjectType>({
        name: '',
        description: '',
    })
                ...
                <form onSubmit={submit}>
                    ...
                    <div className="space-y-4 mt-4">
                        <div className="flex flex-col gap-2">
                            ...
                            <Input id="name-1" name="name" defaultValue={data.name} onChange={handleInputChange} />
                            <InputError message={errors.name} />
                        </div>
                        <div className="flex flex-col gap-2">
                            <Label htmlFor="description-1">Description</Label>
                            <Textarea id="description-1" name="description" defaultValue={data.description} onChange={handleInputChange} />
